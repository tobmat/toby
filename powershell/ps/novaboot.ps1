...
$servernname="tobytest"

$userdata="C:\Users\Toby.Matherly\Documents\GitHub\caas2\scripts\test.ps1"

nova boot --image $image --flavor $flavor $servername --nic net-id=$netid1 --nic net-id=$netid2 --security-groups $secgroup" --user-data $userdata
