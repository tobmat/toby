# Name   : sql_changeMSX.ps1
# Purpose: change msxencryptchanneloptions to 0, reboot server
# Date   : 02/07/2013 
...
if ($sqlversion -eq "2008") {
  # 2008 reg path
  set-itemproperty -path "HKLM:\software\Microsoft\Microsoft SQL Server\MSSQL10.MSSQLSERVER\SQLServerAgent" -name MsxEncryptChannelOptions -value 0
  $msxvalue=(get-itemproperty -path "HKLM:\software\Microsoft\Microsoft SQL Server\MSSQL10.MSSQLSERVER\SQLServerAgent").MsxEncryptChannelOptions
}

if ($sqlversion -eq "2008R2") {
  # 2008R2 reg path
  set-itemproperty -path "HKLM:\software\Microsoft\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\SQLServerAgent" -name MsxEncryptChannelOptions -value 0
  $msxvalue=(get-itemproperty -path "HKLM:\software\Microsoft\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\SQLServerAgent").MsxEncryptChannelOptions
}

if ($sqlversion -eq "2012") {
  # 2012 reg path
  set-itemproperty -path "HKLM:\software\Microsoft\Microsoft SQL Server\MSSQL11.MSSQLSERVER\SQLServerAgent" -name MsxEncryptChannelOptions -value 0
  $msxvalue=(get-itemproperty -path "HKLM:\software\Microsoft\Microsoft SQL Server\MSSQL11.MSSQLSERVER\SQLServerAgent").MsxEncryptChannelOptions
}

if ($msxvalue -eq 0)
{
 "MsxEncryptChannelOptions has been set to 0, rebooting computer in 10 seconds..."
  Start-Sleep -s 10
  restart-computer -Force
} 
else
{
 "Setting wasn't changed, please investigate..."
}

# SIG # Begin signature block
# MIIPWwYJKoZIhvcNAQcCoIIPTDCCD0gCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjmJp3yu1xNf8KyFASnA15/Pm
# pxOgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCBSUUWfshtE
# +dR9loBKsu7R4Q1FMA0GCSqGSIb3DQEBAQUABIIBACg1DWpaOWsON3mAqQVvM/Ik
# EKLOjerwQ3egMFwnFkyPt7RjGkkkIQm9/zsYWWt4WIXrWNLNWb1XjGY1VsQr6glr
# TZ/TUeIb+Z+LHK0kVRpvqRTg2ydg2QNCirV/7rx8cZYh7Kga6VHcPr1zySIH7d+S
# abzdk+IAOemI5VwS/RqgAHaP5TfU/9cj13vDvvqGv/HaXC/XWkIMLA5lZRif1zwn
# fcet/WDMqehKNhCfj3kWXqr5Bgq2j5lNMSQ+qgXu+ZNzm1ZC10mlUJz/WLHH+Q6c
# XWgINPIrNNCi8zV0xWa0p+bIJXWcFPQk8EV5KOTSxMZIzQG49FuP9VOKeRw8VXI=
