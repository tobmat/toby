# Name   : sql_copydirs.ps1
# Purpose: copy directories needed for SQL install
# Date   : 02/07/2013 
...
"Copy SQL 2k8 folders to C: drive..."
copy '\\ssfhs\shared\oshared\groups\database\database\private\documents\sql_server\db paths\c-mssql_scripts\Mssql_scripts_2K8' c:\ -Recurse
}

if ($sqlversion -eq "2012") {
"Copy SQL 2k12 folders to C: drive..."
copy '\\ssfhs\shared\oshared\groups\database\database\private\documents\sql_server\db paths\c-mssql_scripts\Mssql_scripts_2K12' c:\ -Recurse
}

if (! $datadrive) {
  $datadrive = read-host "Enter 'S' for single data drive and 'M' for Multiple data drives (F,G,K): "
}

if ($datadrive -eq "S") {
" Copy SQL folders for Single data drives..."
copy '\\ssfhs\shared\oshared\groups\database\database\private\documents\sql_server\db paths\d-drive only\Mssql' d:\ -Recurse

}

if ($datadrive -eq "M") {
" Copy SQL folders for Multiple data drives..."
copy '\\ssfhs\shared\oshared\groups\database\database\private\documents\sql_server\db paths\f-drive (prod data)\Mssql' f:\ -Recurse
copy '\\ssfhs\shared\oshared\groups\database\database\private\documents\sql_server\db paths\g-drive (prod xlog)\Mssql' g:\ -Recurse
copy '\\ssfhs\shared\oshared\groups\database\database\private\documents\sql_server\db paths\k-drive (tempdb-backup)\Mssql' k:\ -Recurse
}

# SIG # Begin signature block
# MIIPWwYJKoZIhvcNAQcCoIIPTDCCD0gCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUbWsxLY9+ssDX/8+t50D2yENq
# 47Cgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIXorWr9GNCr
# 3dT9UvnQa6GRwOFeMA0GCSqGSIb3DQEBAQUABIIBADl15ym0eRWuWzfrBwjnwS6F
# FNbz8dfWuz+XspAlS0yuQQRaEUDBys28OjcCy4w1G9qSCWFo9HNk91QHdohd28uK
# yz1Po2zdDhFXJMhVntczjN3xD+Gf8nm//EY4J4tP1ro0dt9A2bfWS3bfGKMNv6+l
# Uh6mR7bhgDY0SiwOBBlSi2uSL4hbufBnTuFvaAtGD2f/S2YBl5BlMHuc2DWChOpD
# rFwjEIeRkSPDiDqoLiwjfv+JrZhLtYRQLH9LZ3bcvAn8nBmbWBvB3jX4rU1jlmW9
# TGltinuTxlGPgOQckadjHNHtDiPK3AoUbqLUHG9gZ2Wcg0gX/F48Z3vG8A8JvQc=
