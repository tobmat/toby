...
# Runs cleanup script on OAINTIPCC2, updated 1/29/2014 by x15

$server="OAINTIPCC2"
$log="$logdir\" + $server + "_cleanup_log.txt"
$elog="$logdir\ERROR_" + $server + "_log.txt"
$script="$scriptdir\cleanup_oaintipcc2.ps1"

# Runs cleanup script on oaintipcc2
Invoke-Command -ComputerName $server -filepath $script >  $log
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+RIomrCM0aI1FN5xhep1R048
# trGgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJJVeaqGxnvp
# ei6e2oX7jcYlwcaQMA0GCSqGSIb3DQEBAQUABIIBAFwt6j+pG8cjYbkkhn/M4RZC
# j6hjem11Ktm1IV3Gz9oU9iwn3rdap2K01sNc8P7urqtopimih44KwCFwoWByhbvS
# xh5m0SQN/uX86Hb0at1JjzC8XlUTrygycwMBVDUgXSEGHhHbgV7JaOwCTJhOJVfI
# aw8OpyYfSsBTtdOrx2zfNgJDiZDArgXLKI2RqXfu0pDyAz71xYlJjyJ3sAtdzJ+d
# aRedOwIXLsGDHo2An27VgRkHZVnPRUD+PHRyxr08F1L0SOblAlqYYNP7+zXdIpXr
# oVJscyRmWXnLWSSWzMS0rYJTKWA6/SdLT9Ez3kqIaQJ9sFysR/wSCKTsG7cZMw8=
