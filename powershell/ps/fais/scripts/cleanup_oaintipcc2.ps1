# Name:    cleanup_oaintipcc2.ps1 
# Author:  Toby Matherly
# Date:    02/15/2013
# Details: Deletes anything older than 60 days from data directories in "D:\Recordings\YYYY-MM-DD\oaintipcc2*.wav" and files older than 14 days in "D:\Recordings\*.wav"
# 
#          Powershell remoting is enabled on this server and script remote_cleanup.ps1 is scheduled on oaintpwshell.  This script is run from there.

$CLIENT=$env:computername
$TargetFolder = "D:\Recordings\" 
$Now = Get-Date 
$LastWrite = $Now.AddDays(-14)
$LastWrite2 = $Now.AddDays(-60)
   ...
   if ($File.Attributes -eq "Directory")
      {
        ...
        $TargetFolder2 = $TargetFolder + $File.Name + "\*.wav"
        ...
        foreach ($File2 in $Files2)
        {
         if (! $File2) {
          ...
          $dirinfo = get-childitem $File | measure-object
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUf+PmxN9xvJa33y9pyEDRaWhP
# M12gggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPbJDCBUlnxc
# KiRQDzrZjHcjKyEgMA0GCSqGSIb3DQEBAQUABIIBAHq1NQDFDtWsIql98N2lrVIq
# ay7XB094OzAYFH6lE42QENsLYG/ZFGa112AY3kFRMArwq9vdf6zw3EwyDbTBr4Yo
# fU3qGSA0KbDKlpOgky7pubWPBJCJaRXQa244C779AK7oeGajJV9EbBf+kb7SjR5T
# ct49TY8zzAIo+NqfXEaczzTuQYBCA7uavOE+UfGhJJYRFw623tBn7jFLtwv9zaOI
# MSM5dUPWozcB3jRvU0uKEGQAQdscuYMp3+2u8Ft1iqYiaPhOmjbh0/Aw5U1dJrz3
# G5lmC2fjBkONGRGSbyRjcrctnpyRoIDAgfIoep0qSNs6xlks508MAjxvx7v/vVs=
