...
# Update : this is a copy of the svr_join_domain.ps1 script that will be located on the C:\ drive on the VM templates
# Update : add logic for Citrix based on OS.
...
### 
$continue = read-host "It doesn't appear this server is joined to the domain.  Would you like to join the server now? ('y' or 'n')"
if ($continue -ne "y") {
  "Just open powershell again to join to the domain. Goodbye..."
  exit
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUYcZZJ7CraCpWHk6wvth0fzTV
# BFCgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFL6bqAjR4wt3
# 2UlGNx3xb4NN/TmwMA0GCSqGSIb3DQEBAQUABIIBADnLDOAX1c92/p6wvjno4xgP
# GnlW6zed4F+IlLi1W5UqdjDA4AKK/XlTmpey/4K2rpEeKcpZWBLWI82UcjIk4UFw
# VLd3mjSIp6PD6HupGHX8hHyQvUD8uAN05PJOK+CmcY5RhHDumxJT4Z+7wgG7h+pa
# +cufaWKgqI/Tswq1x0aiFxMhfYqvc9y9edyaiO5lPoBc1bIBVMuG/qpuJs8bWxKb
# tfrnVXHZA0qqpCKqTKBlBeNswNfor/O+lf/URz1ORqpG8J1EMMFQ1k6HB/ids13G
# rhFL2pvjludUNuG94QXGEVT27+cwJxp0EYioJmgYkloG1yZ1VFMHerKn6cxqdVk=
