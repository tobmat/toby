# Name   : sql_add_appsrv.ps1
# Purpose: install application server role to server
# Date   : 02/27/2013 
# Author : Toby Matherly (x15)
#
import-module servermanager
"adding Application Server role..."
Add-WindowsFeature Application-Server, AS-NET-Framework

# SIG # Begin signature block
# MIIMwwYJKoZIhvcNAQcCoIIMtDCCDLACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNix//WSjHpNenk38YEKAIfav
# djGgggq0MIIFMTCCBBmgAwIBAgIKQGBHegABAAApbjANBgkqhkiG9w0BAQUFADBL
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUw7CfaIsYppDMT26uitgJ
# 0xf9O08wDQYJKoZIhvcNAQEBBQAEgYCVQ35iyzuecr2IH6lFgBsRz9EUFWSb7HP0
# 0R2ePfpXvDZBX4DuE5qa8A2a5mKlYbQYMVRt33NhGJZB6wR0sZRfM161rcH0QfAq
# YvaYpH+LvODiGCf+HGpHgyBC/y3OsYxsNhrwDFB+9lU3ySxv4sStBfQwWskcj/af
# 0hXSqxj3YA==
