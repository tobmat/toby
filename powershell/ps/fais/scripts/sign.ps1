...
# syntax: sign <scriptname>
# test to determine if script is the profile script
# Update: Use *pfx file to grab certificate

if (! $global:cert ) {     
  $global:cert = Get-PfxCertificate \\oaintpwshell\scripts\certificate\CorePSsign.pfx
}
if ("$args" -like "*.ps1") {     
 Set-AuthenticodeSignature $args -cert $global:cert
}
else {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvUjJAuNNsG0gGVVhCcvVYx84
# /AWgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFM7jR1f3Ttl5
# nz4PsDiYnL3pygA/MA0GCSqGSIb3DQEBAQUABIIBAEaDxbmT2WnxQ7vNNiO24t+2
# Ozlo+FRv3SY6hCbFR2CAO9Q+Y/vgDfjxDTNWmIlUwt1pi+7kkGw12laZ0LOu1WrN
# Y+U8haYmFLZSleWUnVQPExdk6mb/4CtGRaPt4cvMtAX3CefGXcWogeZsf36Sfuzd
# j0DS4NnEs8LxOOfCnv+X3t01iwASqC5gRkQnjAQGctXha3n4VV4yMoQrfrTfet0N
# iTLUduquK3nS6QRPQQyIxtFskviNG/TjiBSi16zPmRtxlkIYGcWrfo4CDg2l69Mp
# ppTPiML9x0WrP42tCAjxAPRWXNl8r56V9mpCqVMRzman87Wfp8STn881rCOs//A=
