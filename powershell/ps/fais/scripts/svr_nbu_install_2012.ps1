        ...
        default {
	           ...
	           if ($priority -eq "1") {
	             $MASTERSERVER="oairsbkp1" 
                     $ADDITIONALSERVERS="oairsbkp2,oailxbkp6" 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUqeZaWRj1F1N1lcpb+hmTfzpS
# rTKgggq0MIIFMTCCBBmgAwIBAgIKQGBHegABAAApbjANBgkqhkiG9w0BAQUFADBL
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUWqLCb5TLIZNYg+JcPxUc
# n6AV/NcwDQYJKoZIhvcNAQEBBQAEgYBCQb7t5QGpQ9AfbiI0XDrVyKAoRexe0ect
# 8wAqEnJ8Fybil/575uf+B1XTKbXn9GANmFqxOE7hYIrfdAU92v4Ssov1wule1/ER
# JD/PLehuMH1bELfZq8zNAumbn5r1jhOnYcOGj+wLiOkrvEpGmAj2qSUzaQyl8wEP
# dRtHsL+ikA==
