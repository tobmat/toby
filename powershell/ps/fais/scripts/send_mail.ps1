...
# Details: sends emails 
# Example: send_mail "Test Subject" "Test Body" "toby.matherly@franciscanalliance.org"
# NOTE   : If your script needs to send a page the server it is running from needs to be in relay list. 
#        : This is added via a security request.
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUSyTymDSVFh/skDN57+jx6svd
# 7mCgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGE0Cefu4I2Q
# ztaCPAhGhXvVuImTMA0GCSqGSIb3DQEBAQUABIIBACyZFPtCAXjoYGVtSAUrw/Nu
# VruACZvjE54I4lIOTkMcfHPXDjmG/wfRy15T01zyMgUKqc4H0dtQ9lmuhZ+tBqy1
# tX2RaEiV77HarxxUj/D8gRzv0JJhakzB36LR0GP2/CJB313DTvfU7w+hpg6txPH7
# Zr+ytcoPKBy3AYxhVr8PPwYYmR9NPLyqMNqTYBLfeT6jJ9pgS5oMmUPGkF35fFCz
# 6+SyD7l66sL5y6Lc33TZ6Ld+L/SZOCmju9PG0LCCiEE4zbz/T90IAkIU8KN3/JxB
# 0m+m4w4Ok+quoeAWYAW2jf+ZfTr8Wmlu/LvsU+a4bCS2ZkJGsOppuOaoBm/phTo=
