$profile="$env:windir\System32\WindowsPowerShell\v1.0\profile.ps1"
if (test-path -Path "\\ssfhs\shared\Oshared\Groups\Source\")
{
 ##cd \\oaintpwshell\scripts
 $ep = get-executionpolicy
 if ($ep -eq "Bypass") { set-executionpolicy allsigned }
 ##\\oaintpwshell\scripts\svr_menu.ps1
 function prompt
 {
   Write-Host($(get-location).providerpath + ">") -nonewline 
   return " "
 }
}
else
{
 if (test-path -Path "C:\local_join_domain.ps1")
  {
    C:\local_join_domain.ps1
  }
 else
  {
    "C:\local_join_domain.ps1 does not exist, let Toby know"
  }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUzY+DhbYIfxAKeVIroUyqfIZ5
# Yfegggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKgDEREtcc0G
# 7+0C7K4KTrM4p0K5MA0GCSqGSIb3DQEBAQUABIIBABJoIHI+s/FHgQCLsZscnSOe
# fm67q/CHDgftJczRmF+onbAHqgc+tbgk2HRFjdPj8caxZtmgs3G1neM7rMZFKqSJ
# RWUouxYvbk1jpItg9Dx4khTiM0oVE+HDW5HYiXk8cE5u8oRizIpNWV6VR/Ixzcl+
# cwPH6mPJ55rmtrAeH2bGhCev7A0X8RJWF98I3kIM8C54pt+To/b45pCFuQ7ZlVtF
# RsMW7ZfSukcVzvXGAz1/a69QYX1MEDewjQPMai4Mv5+imvJN4/HqqrCHtGaIxOL0
# zd8AAt18tF3GsoDtxt79J+XeOplpgIoONnwE0XVDBnHvw3UdqoX3I0FAlAGuB2M=
