Stop-Service -force -InputObject (Get-Service -DisplayName "Planning Application Services*" -cn OAINTKHAPP1) -Verbose
Start-Sleep -Seconds 5 -Verbose
Start-Service -InputObject (get-service -DisplayName "Planning Application Services*" -ComputerName "OAINTKHAPP1") -Verbose
Start-Sleep -Seconds 5 -Verbose
get-service -DisplayName "Planning Application Services*" -ComputerName "OAINTKHAPP1"-Verbose
# SIG # Begin signature block
# MIIPWwYJKoZIhvcNAQcCoIIPTDCCD0gCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDOgLcjB4FXjV6F7fe49IlWkT
# ubOgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFAwL+B3F/zMM
# xbLIucEZ8yTVtUS9MA0GCSqGSIb3DQEBAQUABIIBAB9ML3XvHGQoRJl8SQliNV5K
# VtT8sSdpVSYCOqRilpzUUNByYluT5iI1w/oJCPfLv/B0xECl2GbYgtIgI9RkNoq9
# lSZk763yiDOrUP3ezZkWKf3z4zP73dSWvCYHrLcQqQs2r8zdyMaegQxeOApbmsT4
# eMLyQ5K4DYHHs+52Ae9HdNkW+7RhyZRUU73DBOnPccBvIodfUTP9fm6OlirfMX6e
# gJOGdt1Xefk7gWbgVwvEhvAIup/GGbwlBhuJ+LcnYDDSlGGoCHc/iPxUER5P/ZVw
# vyPgKeu+pyex0fY7EJwmbMaINTOtcS5l8Po9+Sw/I4r0JIFEKIMbH/G/Ka73Io8=
