# Name   : sql_servicepack.ps1
# Purpose: install SQL Server Service Pack
# Date   : 02/07/2013 
...
if ($sqlversion -eq "2008") {
   ...
   #
   "installing SP2 64bit.."
   & '\\oaincofs\dbsource\sql server\2008\Updates\x64-SP2\SQLServer2008SP2-KB2285068-x64-ENU.exe' /quietsimple /action="patch" /allinstances /indicateprogress
   ###"installing SP3 64bit.."
   ###& '\\oaincofs\dbsource\sql server\2008\Updates\SP3\SQLServer2008SP3-KB2546951-x64-ENU.exe' /quietsimple /action="patch" /allinstances /indicateprogress 
  
   "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" 
   "Remember to change local security policy per instructions..."
   "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" 
}
...
if ($sqlversion -eq "2008R2") {
   ...
   # install latest service pack
   # 64 bit SP2
   & '\\oaincofs\dbsource\sql server\2008R2\Updates\SP2\SQLServer2008R2SP2-KB2630458-x64-ENU.exe' /quietsimple /allinstances /indicateprogress /IAcceptSQLServerLicenseTerms
   # 32 bit SP2 - need to add logic to support
   #& '\\oaincofs\dbsource\sql server\2008R2\Updates\SP2\SQLServer2008R2SP2-KB2630458-x86-ENU.exe' /quietsimple /allinstances /indicateprogress /IAcceptSQLServerLicenseTerms
}

if ($sqlversion -eq "2012") {
   # install latest service pack
   # 64 bit SP1
   & '\\oaincofs\dbsource\sql server\2012\Updates\SP1_X64\SQLServer2012SP1-KB2674319-x64-ENU.exe' /quietsimple /allinstances /indicateprogress /IAcceptSQLServerLicenseTerms
}

# SIG # Begin signature block
# MIIPWwYJKoZIhvcNAQcCoIIPTDCCD0gCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7H4mBCkrDVULmRVV1ZfL9GKG
# htWgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIOfnXjpzq5c
# GnyOazHUUe5mqF19MA0GCSqGSIb3DQEBAQUABIIBAE9nmNa3B+cHfoI/ziV3hmyU
# tQTFYLXZhz/0F1aJPRz/12YaiS2/i5Q2o7IiBzR/NaPt/9m/Ev3B6VcS5ukjPkQd
# 6lZhR6peU12zpVzSpY15E9KuFLdwYKuOZ5m3sgMIy/Wp0Gwd8yDPxrQMI6jcNr1Z
# oHdQQnSuWaHX/I7scNCvzNASet8nG+KemXT/Sffs2oXC2NwlXLlGJGuewBtKGbPk
# vpNOVtdlVu0i7tvD9QxglvfF5C4l0Y2MWjtiPUb8oQa9uJfArnQBtHb9Xa9/KcKb
# HIDE740mQ5+1d/gbN4VgzX+6UJhr2hTJj9A/wRPVMWwzfLuv8SZ/Y97GbVoOQKE=
