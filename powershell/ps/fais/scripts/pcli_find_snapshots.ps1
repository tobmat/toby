...
"`nScript to generate list of all snapshots."
if ($help) {
"Optional parameters:
...
write-host "`nGetting all existing snapshots..."
Get-VM | Get-Snapshot -ErrorAction silentlycontinue | select created, VM, SizeMB 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJt9y0w5Mm6Ax2hUEH+EUITQ8
# RJugggq0MIIFMTCCBBmgAwIBAgIKGMkYXwABAAAoajANBgkqhkiG9w0BAQUFADBL
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUAnUdd+f2LwV/7bLI2oxW
# 6dENUncwDQYJKoZIhvcNAQEBBQAEgYCrO4RvdOhXn2B3m0whxbvxn4YDJhU5sS+Q
# V3u6E4aRyq6tmGE5NqBxl+pF/ZqWlNNpsNLz5iB0gXJxJimx5V6Ev9Rwed592kV4
# Nh+VEu1cv3VmnrPQolRlGD2fb0N1+DskEfZISVEG84fAedKeLT7Hbl98SZ2zDt+B
# O0x3/FgiEA==
