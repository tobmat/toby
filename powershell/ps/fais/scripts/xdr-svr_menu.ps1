...
while ($choice -ne "x")
{
 ...
 "5. Forefront Install"
 "6. Combo (baseline, NBU, and forefront)"
 "7. Change Execution Policy to Allsigned"
 "8. Install SCCM"
 "9. Leftovers (disable LMhosts, IE ESC for Admins, and UAC; create Reboot task)"
 "x. Exit"
 " "
 ...
 switch -regex ($choice) {
     ...
     "[4]" { 
	    ...
	    "====================== "
            ...
            {
              \\oaintpwshell\scripts\svr_nbu_install_2012.ps1
            }
           }
     "[5]" { 
	    "================= "
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUT8tRip9eYCRIZ8SlAPkRx/Dc
# oAWgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCAoZRwKtnz5
# 6AnLIeELPEW1M6YDMA0GCSqGSIb3DQEBAQUABIIBAFoz1ak6ltZZt68ISEvBVjEC
# TlQjdT8PXhHcMzeyOdCGHyvvh61IAUny6eaU/bcq525AgEGr4yBH/DH/JvTJ9Pjr
# mOE0L4dOK8xhBN7JgbTzP8+nMMu0676Bni/Y/Fpm0dfcBo5G/oI4+Qngjx/gU7/V
# zrh4p4PZeOkou4aG8iKbQaF/D2KvgyDBEuOmipwXXzdVoAKvKNkwQkN0vxhIfVVf
# 2CufvvjAeOW8Zr3R4sKqVj+v6rMrw6K5Wz+l135EEQcx8M+i5Ws8u6BpUm2lcCiG
# B7MAHwIZggAcNPRo4REQ3GgGpX+FfdeEnrlHAIE4dl0AJoLM0XFR9/8Aje5d83I=
