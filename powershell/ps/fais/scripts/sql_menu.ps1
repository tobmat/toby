# Name   : sql_menu.ps1
# Purpose: Menu driven script to execute SQL install scripts
# Date   : 02/07/2013 
...
Start-Transcript -path c:\powershell_sql_log-$ts.txt
while ($choice -ne "x")
{
 "========================"
 "= SQL Install Menu 2.0 ="
 "========================"

 "1. Add SQL accounts to local admin"
 "2. Add application server role"
 "3. Copy SQL files, data drive files"
 "4. SQL install"
 "5. SQL install latest SP"
 "6. Change Registry Settings"
 "7. Submit NBU request"
 "8. Enable SQL powershell commands (2008 OS)"
 "9. Run Configuration Scripts"
 "x. Exit"
 " "
 ...
 switch -regex ($choice) {
     "[1]" { 
	    "=============================== "
            "Add SQL accounts to local admin"
	    "=============================== "
            " "
            \\oaintpwshell\scripts\sql_accounts.ps1
           }
     "[2]" { 
	    "=========================== "
	    ...
	    "=========================== "
            " "
            \\oaintpwshell\scripts\sql_add_appsrv.ps1
            clear
           }
     "[3]" { 
	    "================================ "
            "Copy SQL files, data drive files"
	    "================================ "
            \\oaintpwshell\scripts\sql_copydirs.ps1
            " "
           }
     "[4]" { 
	    "=========== "
            "SQL install"
	    "=========== "
            \\oaintpwshell\scripts\sql_install.ps1
            " "
           }
     "[5]" { 
	    "===================== "
            "SQL install latest SP"
            "===================== "
            \\oaintpwshell\scripts\sql_servicepack.ps1
            " "
           }
     "[6]" { 
            "Change Registry Settings..."
            \\oaintpwshell\scripts\sql_changeMSX.ps1
           }
     "[7]" { 
            "Submit NBU request"
            start-process -filepath http://web/ais/operationsforms/NetbackupRequestForm.aspx
           }
     "[8]" { 
            "Enable powershell SQL commands"

             \\oaintpwshell\scripts\Initialize-SqlpsEnvironment.ps1
           }
     "[9]" { 
            "Run Configuration Scripts"
             ##explorer "\\ssfhs\shared\oshared\Groups\Database\Database\Private\Documents\SQL_Server\MSSQL_Scripts\Binn\"
             \\oaintpwshell\scripts\sql_config_scripts.ps1
           }
     "[x]" { 
            "Thanks for playing"
           }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhkKKCYkTw8iVHdxPN0Z25nrr
# 8Sygggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKZqN3c3nt+H
# S3IrhkyYGy0BV891MA0GCSqGSIb3DQEBAQUABIIBADIYyvuTZVi4GUj6wo9Zuzwd
# q4ANQQDBFmIYB3bhdgyn0xMFk0AWmks6HwHXp5w8eydyshEF2VutgBHM6iEl31Ya
# he5kYyQqyN+HiDBJh2op6vCWJlx9CE6/4wpuRdNlaj42txH31dC1f/AexMpsGTZo
# ZdHj2xa+r1eQ9ZMG0CteBc8ygUJx5XoE5o4dZDxC+OvUF+iZHii7j1dGhTbv4IiH
# 8mRdopIxYRgyxkaWP6Aw3jCtrBoPnElsam3fti51z/ienS9jrZNKogsRyA5Om6Kt
# FG7SrZbEceNeHvbVXMhmdOS+Dfs6cnPowiZirQc+5/dfTaM0chfCQz5uvp5da5E=
