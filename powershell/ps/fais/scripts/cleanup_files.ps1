# Name:    cleanup_files.ps1 
# Author:  Toby Matherly
# Details: generic cleanup script that is passed parameters for days and target folder
#          Powershell remoting is enabled on destination servers and script is run through remote_cleanup.ps1
...
foreach ($File in $Files) 
 {
  if (! $File) {
    $Now.ToString() + " +++ No file(s) to delete +++" 
  }
  else {
    $Now.ToString() + " +++ Deleting File $File +++" 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUymIgFTllSo4h7uvMfOZpmbcU
# weagggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNqE95JLDauY
# CN6CW+zusfXxLJPCMA0GCSqGSIb3DQEBAQUABIIBAFEyMjaWNpOgBDa7vYRTN0u9
# A9Ye3Ld5NzX0vRovGLTu6lMR8DmlsmuB7dgGCzQYCrQrKZoF1cQYsIy3DT66kfOy
# ytGVm7iHQ31Onf004F5PAt5xBIrbGGQqVY9PjzoOdZOuJ0CmDdapxMi9ikAyuT5T
# DMEssFYZTl3uHqhTdJiFBzP+lXWbxRlm5A+yNniXqVZ2YoPVcMOBWEbIL/3uVhu2
# QByP3YiCIr6oXVQgF+p/AnuA0nu6x7A97QjgG8sbEIeATftni9tDADnOJ0P3ySh0
# qa3QXlWTf24+UKRvVlw/gsLpV9/hzlb+8YpzRX+SzjQoxrkA2L9z+MiEi+Ume3A=
