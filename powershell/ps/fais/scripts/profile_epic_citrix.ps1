 if (test-path -Path "C:\local_join_domain.ps1")
  {
    ...
    del $profile.AllUsersAllHosts
  }
 else
  {
    "WARNING::: C:\local_join_domain.ps1 does not exist, let Toby know"
  }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmyii6bPrc6HY91k6Tmp8Xn+2
# a1Wgggy/MIIF5zCCBM+gAwIBAgIKYU4uYQAAAAAAAzANBgkqhkiG9w0BAQUFADAm
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCetnsk5NaAQ
# Dkaem4DhQRYqpWxuMA0GCSqGSIb3DQEBAQUABIIBAHza5UZr4a/GiJ8hEUMh6w3z
# I0/gsu2WxOuBkyE8BSCr8AL+WBgJyqGV3taYajfkv1C8KtJQXEV5hS2G96zdCKKX
# HSfTUsscwn58Kx5fWk/mWGdghIZ2gVtGbl9C417awd5uGp9wuRjJV3l/+1Dtl4Y/
# Js6vNc0wS4X+wsEbZti3k089i5pZdrpbfr4JmSxM6muD88ijW/Ef9Ys2bhyLQLiI
# sMgmLDF20oE5S74+0iDG39l14P075xLbMtX8gJcCVhNJUq+TFk4QERf1r3+Pm52A
# HDY5UBBT2VuqBIF38McJPdo7jKSiciYtr8DAqlXKZABjopiS6zYPvihXM8yspHs=
